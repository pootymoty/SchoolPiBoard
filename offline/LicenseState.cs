...
/// Сохраняется в %APPDATA%\DoskaPi\license.dat (см. <see cref="LicenseStorage"/>).
/// </summary>
...
public static class LicenseOptions
{
    ...
    /// DOSKAPI_LICENSE_URL и поле LicenseServerUrl в settings.json.
    /// </summary>
    public const string DefaultServerUrl = "https://keys.school-pi.online";

    public const string ServerUrlEnvironmentVariable = "DOSKAPI_LICENSE_URL";
